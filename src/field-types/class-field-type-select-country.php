...
class Field_Type_Select_Country extends \BP_XProfile_Field_Type implements Field_Type_Selectable {
	...
	private static function get_countries() {
		return array(
			...
			'GB' => __( 'United Kingdom (UK)', 'bp-xprofile-custom-field-types' ),
			'US' => __( 'United States (US)', 'bp-xprofile-custom-field-types' ),
			'UM' => __( 'United States (US) Minor Outlying Islands', 'bp-xprofile-custom-field-types' ),
