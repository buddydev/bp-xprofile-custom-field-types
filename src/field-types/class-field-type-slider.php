...
class Field_Type_Slider extends \BP_XProfile_Field_Type {
	public function __construct() {
		...
		$this->name     = __( 'Range input (HTML5 field)', 'buddypress-xprofile-custom-fields-types' );
	...
	public function admin_new_field_html( \BP_XProfile_Field $current_field, $control_type = '' ) {
        ...
        <h3><?php esc_html_e( 'Write min and max values.', 'buddypress-xprofile-custom-fields-types' ); ?></h3>
            <div class="inside">
                <p>
