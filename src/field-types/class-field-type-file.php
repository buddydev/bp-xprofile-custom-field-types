...
class Field_Type_File extends \BP_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( 'File', 'xprofile field type', 'buddypress-xprofile-custom-fields-types' );
	...
	public static function display_filter( $field_value, $field_id = 0 ) {
		...
		$new_field_value = sprintf( '<a href="%s" rel="nofollow" class="bpxcftr-file-link">%s</a>', esc_url( $new_field_value ), __( 'Download file', 'buddypress-xprofile-custom-fields-types' ) );
