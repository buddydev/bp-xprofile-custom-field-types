...
class Field_Type_Decimal_Number extends \BP_XProfile_Field_Type {
    ...
    public function __construct() {
	    ...
	    $this->name     = __( 'Decimal number (HTML5 field)', 'buddypress-xprofile-custom-fields-types' );
	...
	public function admin_new_field_html( \BP_XProfile_Field $current_field, $control_type = '' ) {
        ...
        <div id="<?php echo esc_attr( $type ); ?>" class="postbox bp-options-box" style="<?php echo esc_attr( $class ); ?> margin-top: 15px;">
            <h3><?php esc_html_e( 'Options', 'buddypress-xprofile-custom-fields-types' ); ?></h3>
            <div class="inside">
                <p>
                    <label for="bpxcftr_decimal_precision"><?php _e('Precision', 'buddypress-xprofile-custom-fields-types');?></label>
                ...
                <p>
                    <label for="bpxcftr_decimal_step_size"><?php _e('Step Size', 'buddypress-xprofile-custom-fields-types');?></label>
                    <input type="text" value="<?php echo esc_attr( $current_step);?>" name="bpxcftr_decimal_step_size" />
                </p>
                <p><?php _e('Use decimal in step e.g .05, 1.3 etc, otherwise the field will behave as number','buddypress-xprofile-custom-fields-types' );?></p>
            </div>
        </div>
		<?php
	}
